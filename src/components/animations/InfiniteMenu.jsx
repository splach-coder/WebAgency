    ...
    Promise.all(this.items.map(item =>
      ...
      images.forEach((img, i) => {
        ...
        if (imgAspect > cellAspect) {
          ...
          drawHeight = cellSize;
          drawWidth = img.width * (cellSize / img.height);
          offsetX = x - (drawWidth - cellSize) / 2;
          offsetY = y;
        } else {
          // Image is taller: fit width, crop top/bottom
          drawWidth = cellSize;
          drawHeight = img.height * (cellSize / img.width);
          offsetX = x;
...
export default function InfiniteMenu({ items = [] }) {
  ...
  return (
    <div className="relative w-full h-full text-sage-darker">
      <canvas
      ...
      {activeItem && (
        ...
        `}
          >
            <p className="select-none relative text-white top-[2px] text-[26px]">
              &#x2197;
            </p>
          </div>
        </>
